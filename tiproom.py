...
DECLARATION = Declaration(
    ...
    commit_means="she tips that wallet a share of her free paper balance, rounded down to whole cents",
    reward_source="A recorded practice thank-you brings sugar to the cells from her look; silence brings nothing, and this room brings no shock.",
    chosen=["People supply eight practice wallets; longer holding times make larger cards, up to three hundred and sixty-five days.",
            ...
            "This room uses paper money only and gives her no smells.",
    ...
    how=("her eye settles on a wallet card for at least two rounds; this room adds no smell.",
         ...
         "when she stops, the strength of her drive sets the share of free paper money she tips; either sign tips, zero does not.",
